...
<body>
  ...
  <form id="invoiceForm">
    ...
    <div id="companyDetails" class="form-section hidden">
      <label>Company Name: <i class="fas fa-building"></i></label>
      <input type="text" name="company_name">

      <label>Address: <i class="fas fa-map-marker-alt"></i> </label>
    ...
    <div class="form-section">
      ...
      <label>Invoice Date: <i class="fas fa-calendar-alt"></i> </label>
      <input type="date" name="invoice_date" required>

      <label>Terms: <i class="fas fa-clipboard-list"></i> </label>
      <input type="text" name="terms">

      <label>Due Date: <i class="fas fa-hourglass-end"></i> </label>
    ...
    <div class="form-section">
      <label>Sub Total: <i class="fas fa-calculator"></i> </label>
      <input type="text" name="subtotal" id="subtotal" readonly>

      <label>Total: <i class="fas fa-money-bill"></i> </label>
      <input type="text" name="total" id="total" readonly>

      <label>Advance Payment: <i class="fas fa-coins"></i> </label>
      <input type="text" name="advance_payment" id="advance_payment" oninput="calculateBalanceDue()">

      <label>Balance Due: <i class="fas fa-wallet"></i> </label>
      <input type="text" name="balance_due" id="balance_due" readonly>

      <label>Total in Words: <i class="fas fa-spell-check"></i> </label>
      <input type="text" name="total_words" id="total_words" readonly>
    </div>

    <div class="form-section">
      <h3>Payment Details:</h3>
      <label>Payment Method: <i class="fas fa-money-check-alt"></i> </label>
      ...
      <div id="bankFields">
        <label>Account Holder Name: <i class="fas fa-user"></i> </label>
        <input type="text" name="account_holder_name">

        <label>Bank Name: <i class="fas fa-university"></i> </label>
        <input type="text" name="account_name">

        <label>Account Number: <i class="fas fa-hashtag"></i> </label>
        <input type="text" name="account_number">

        <label>Account Type: <i class="fas fa-exchange-alt"></i> </label>
        <input type="text" name="account_type">

        <label>IFSC Code: <i class="fas fa-code"></i> </label>
        <input type="text" name="ifsc_code">

        <label>Branch: <i class="fas fa-map-signs"></i> </label>
        <input type="text" name="branch">

        <label>SWIFT Code: <i class="fas fa-globe"></i> </label>
        <input type="text" name="swift_code">
      </div>

      <div id="upiField" class="hidden">
        <label>UPI Account Name: <i class="fas fa-user"></i> </label>
        <input type="text" name="upi_name" placeholder="Enter UPI name">

        <label>UPI ID: <i class="fas fa-id-badge"></i> </label>
